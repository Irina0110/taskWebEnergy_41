const rangeSliderInit = () => { // создаем функцию инициализации слайдера
    ...
    const inputMin = document.getElementById('from'); // Ищем input с меньшим значнием
    const inputMax = document.getElementById('to'); // Ищем input с большим значнием
    ...
    noUiSlider.create(range, { // инициализируем слайдер
            start: [15000, 80000], // устанавливаем начальные значения
